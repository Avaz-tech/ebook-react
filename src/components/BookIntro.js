...
export class BookIntro extends Component {
  ...
  render() {
    return (
      ...
      <div className="img-container a"><img src="" alt="" /></div>
      <ul className="book-inf b">
        <li className="book-title">Atomic Habits</li>
        <li>By: James Clear</li>
        <li>Released: October 16, 2018</li>
        <li>Publishers: Penguin: Avery</li>
        <li>ISBN: 9780735211292  </li>
      </ul>
      ...
      <div className="description e">
        ...
        <p className="content">No matter your goals, Atomic Habits offers a proven framework for improving–every day.
         James Clear, one of the world’s leading experts on habit formation, reveals practical strategies
         that will teach you exactly how to form good habits, break bad ones, and master the tiny behaviors that lead to remarkable results.
         ...
         Along the way, readers will be inspired and entertained with true stories from Olympic gold medalists, award-winning artists, business leaders,
         life-saving physicians, and star comedians who have used the science of small habits to master their craft and vault to the top of their field.</p>
      </div>
      </div>
      </>
    )  
